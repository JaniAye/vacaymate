...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/buttonset.css') }}">
...
<body>
                        ...
                        <div id="date-picker-container">
                            ...
                            <div id="date-picker-display-container">
                                <div class="date-picker-display-pair">
                                    <div class="date-picker-display" id="stDate">
                                        24 Dec
                                    </div>
                                ...
                                <div class="date-picker-display-pair">
                                    <div class="date-picker-display" id="endDate">
                                        28 Dec
                                    </div>
                                    <div class="date-picker-display-label">
                                        Last Date
    ...
    <script>
        ...
        function getBookingByPackage(pkgId) {
            endpointUrl = `/getBooking/${pkgId}`;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    document.getElementById('stDate').textContent = formatDate(response.data.st_date);
                    document.getElementById('endDate').textContent = formatDate(response.data.end_date);
                    document.getElementById('date-picker-date-first').textContent = response.data.st_date;
                }
            });
        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        } else if (response.data.package.type === 'GUIDE') {
                            document.getElementById("locDiv").style.display = "none";
                            document.getElementById("vehiDiv").style.display = "none";
                            document.getElementById("accDiv").style.display = "none";
