    ...
    <div class="container-xxl py-5 " style="margin-top: 16vh">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">vehicles</h6>
                <h1 class="mb-5">All Vehicles</h1>
            </div>
            <div id="packageList">
                                ...
                                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="package-item">
                                            ...
                                            <div class="text-center p-4">
                                                <h3 class="mb-0">${response.data[i].model}</h3>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="coverAreas">${response.data[i].vehicle_no}</p>
