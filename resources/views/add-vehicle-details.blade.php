                ...
                <div class="col-lg-3 col-xl-8 wow fadeInUp " style="background-color: #fff; width : 75%;"
                    ...
                    <div class="m-3">
                        ...
                        <div class="radio-button-container mt-3">
                            ...
                            <div class="radio-button">
                                <input type="radio" class="radio-button__input" id="radiovn" name="radio-group">
                                <label class="radio-button__label" for="radiovn">
                                    <span class="radio-button__custom"></span>
                                    Van
                                </label>
                            </div>
                            <div class="radio-button">
                                <input type="radio" class="radio-button__input" id="radiobs" name="radio-group">
                                <label class="radio-button__label" for="radiobs">
                                    <span class="radio-button__custom"></span>
                                    Bus
                                </label>
                            </div>
                            <div class="radio-button">
                                <input type="radio" class="radio-button__input" id="radiobk" name="radio-group">
                                <label class="radio-button__label" for="radiobk">
                                    <span class="radio-button__custom"></span>
                                    motorbike
                                </label>
                            </div>
                            <div class="radio-button">
                                <input type="radio" class="radio-button__input" id="radiotk" name="radio-group">
                                <label class="radio-button__label" for="radiotk">
                                    <span class="radio-button__custom"></span>
                                    Tuk Tuck
                                </label>
                            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-12 col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                    <p class="mt-5" style=" font-size: 17px; color:black">If this package feels
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem est quidem unde
                        voluptatem, et
                        facere tenetur beatae neque debitis commodi illum eos fuga, assumenda aliquam
                        asperiores
