        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a class="nav-item nav-link active" onclick="contactClick()" id="contactTab">Guides</a>
    ...
    <div class="container-xxl py-5 " style="margin-top: 16vh">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">guides</h6>
                <h1 class="mb-5">All Guides</h1>
            </div>
            <div id="packageList">
                                ...
                                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="package-item">
                                            ...
                                            <div class="text-center p-4">
                                                <h3 class="mb-0">${response.data[i].guide_name}</h3>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="coverAreas">${response.data[i].isTranslator}</p>
                                                    <p class="coverAreas">${response.data[i].discription}</p>
                                                    <div class="d-flex justify-content-center mb-2">
                                                        ...
                                                        <button id="${response.data[i].id}" class="btn btn-sm btn-primary px-3"
