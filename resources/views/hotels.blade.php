        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a class="nav-item nav-link active" onclick="aboutClick()" id="aboutTab">Hotels</a>
                                ...
                                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="package-item">
                                            ...
                                            <div class="text-center p-4">
                                                <h3 class="mb-0">${response.data[i].hotel_name}</h3>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="coverAreas">${response.data[i].location}</p>
                                                    <p class="coverAreas">${response.data[i].type}</p>
