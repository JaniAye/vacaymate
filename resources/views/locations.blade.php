        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a class="nav-item nav-link active" onclick="locationsClick()" id="locationTab">Locations</a>
    ...
    <div class="container-xxl py-5 " style="margin-top: 16vh">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">locations</h6>
                <h1 class="mb-5">All Locations</h1>
            </div>
            <div id="packageList">
    ...
    <script>
                                ...
                                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="package-item">
                                            ...
                                            <div class="text-center p-4">
                                                <h3 class="mb-0">$${response.data[i].name}</h3>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="coverAreas">${response.data[i].city}</p>
                                                    <div class="d-flex justify-content-center mb-2">
                                                        <button id="seeMoreBtn${i}" class="btn btn-sm btn-primary px-3 border-end"
                                                            style="border-radius: 30px 0 0 30px;" onclick="seeMore(${response.data[i].name})">Read More</button>
                                                        <button class="btn btn-sm btn-primary px-3" id="${response.data[i].name}"
        ...
        function pickNow(event) {
            ...
            $.ajax({
                ...
                data: picknow,
                success: function(response) {
                    alert('Location Picked Successfully');
                },
                error: function(jqXHR, textStatus, errorThrown) {
