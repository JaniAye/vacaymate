...
<head>
    <meta charset="utf-8">
    <title>VacyMate - Travel Agency HTML Template</title>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="package-carousel">
                <div class="col-lg-4 col-md-6 wow fadeInUp carousel-itm" data-wow-delay="0.5s">
                ...
                {{-- <div style="background-color: red; width:1px"></div> --}}
                <div class="col-lg-4 col-md-6 wow fadeInUp carousel-itm" data-wow-delay="0.5s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/package-3.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp carousel-itm" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                ...
                {{-- jj --}}
                <div class="col-lg-4 col-md-6 wow fadeInUp carousel-itm carousel-itm" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
